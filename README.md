...
> FORK of nhooyr.io/websocket v1.8.7
> update dependencies (also deprecated ones!)
...
- [Single dependency](https://pkg.go.dev/github.com/marco-rozz/websocket?tab=imports)
- JSON and protobuf helpers in the [wsjson](https://pkg.go.dev/github.com/marco-rozz/websocket/wsjson) and [wspb](https://pkg.go.dev/github.com/marco-rozz/websocket/wspb) subpackages
- Zero alloc reads and writes
- Concurrent writes
- [Close handshake](https://pkg.go.dev/github.com/marco-rozz/websocket#Conn.Close)
- [net.Conn](https://pkg.go.dev/github.com/marco-rozz/websocket#NetConn) wrapper
- [Ping pong](https://pkg.go.dev/github.com/marco-rozz/websocket#Conn.Ping) API
- [RFC 7692](https://tools.ietf.org/html/rfc7692) permessage-deflate compression
- Compile to [Wasm](https://pkg.go.dev/github.com/marco-rozz/websocket#hdr-Wasm)

## Roadmap

- [ ] HTTP/2 [#4](https://github.com/marco-rozz/websocket/issues/4)
...
- Minimal and idiomatic API
  - Compare godoc of [github.com/marco-rozz/websocket](https://pkg.go.dev/github.com/marco-rozz/websocket) with [gorilla/websocket](https://pkg.go.dev/github.com/gorilla/websocket) side by side.
- [net.Conn](https://pkg.go.dev/github.com/marco-rozz/websocket#NetConn) wrapper
...
- Idiomatic [ping pong](https://pkg.go.dev/github.com/marco-rozz/websocket#Conn.Ping) API
  - Gorilla requires registering a pong callback before sending a Ping
- Can target Wasm ([gorilla/websocket#432](https://github.com/gorilla/websocket/issues/432))
- Transparent message buffer reuse with [wsjson](https://pkg.go.dev/github.com/marco-rozz/websocket/wsjson) and [wspb](https://pkg.go.dev/github.com/marco-rozz/websocket/wspb) subpackages
- [1.75x](https://github.com/nhooyr/github.com/marco-rozz/websocket/tag/v1.7.4) faster WebSocket masking implementation in pure Go
...
- [CloseRead](https://pkg.go.dev/github.com/marco-rozz/websocket#Conn.CloseRead) helper ([gorilla/websocket#492](https://github.com/gorilla/websocket/issues/492))
...
The [net.Conn](https://pkg.go.dev/github.com/marco-rozz/websocket#NetConn) can help in transitioning
to github.com/marco-rozz/websocket.
...
However when writing idiomatic Go, github.com/marco-rozz/websocket will be faster and easier to use.
